...
const MT = {
  de: {
    title: 'Mind-Map Generator', sub: 'KI-generiert · Interaktiv · Sketch oder Clean',
  ...
  en: {
    title: 'Mind-Map Generator', sub: 'AI-generated · Interactive · Sketch or Clean',
  ...
  ru: {
    title: 'Генератор Майнд-Карт', sub: 'ИИ-генерация · Интерактив · Эскиз или Чистый',
