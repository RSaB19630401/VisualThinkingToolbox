// primitives.js — Shared SVG drawing helpers (hand-drawn Bikablo style)
...
/** Hand-drawn rounded rectangle path */
export function rr(x, y, w, h, rad, rng, a = 2) {
  const r = () => (rng() - 0.5) * a;
  const c = Math.min(rad, w / 2, h / 2);
...
/** Arrow with hand-drawn line + arrowhead */
