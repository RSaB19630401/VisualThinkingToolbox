...
const VT = {
  de: {
    title: 'Wertequadrat', sub: 'Nach Schulz von Thun · KI-generiert · Sketch oder Clean',
  ...
  en: {
    title: 'Value Square', sub: 'Based on Schulz von Thun · AI-generated · Sketch or Clean',
  ...
  ru: {
    title: 'Квадрат Ценностей', sub: 'По Шульцу фон Туну · ИИ · Эскиз или Чистый',
