...
export const T = {
  de: {
    title: 'Sketchnote Visualizer', sub: 'Strukturiert · Frei · Profi-Karten · Bikablo-Stil',
    ...
    structured: '📦 Strukturiert', freeSketch: '🎨 Freie Skizze', proCards: '🃏 Profi-Karten',
    loading: 'Sketchnote wird erstellt...', neu: '← Neu', reroll: '🎲 Neu würfeln',
    edit: '📝 Bearbeiten', done: '✓ Fertig', boxes: '📦 Kästchen', freeL: '🎨 Frei', proL: '🃏 Profi',
    ...
    steps: [
      { id: 'style', l: 'Stil', q: 'Darstellungsstil?', o: ['📦 Strukturiert', '🎨 Freie Skizze', '🃏 Profi-Karten'] },
  ...
  en: {
    title: 'Sketchnote Visualizer', sub: 'Structured · Free · Pro Cards · Bikablo Style',
    ...
    structured: '📦 Structured', freeSketch: '🎨 Free Sketch', proCards: '🃏 Pro Cards',
    loading: 'Creating sketchnote...', neu: '← New', reroll: '🎲 Reroll',
    edit: '📝 Edit', done: '✓ Done', boxes: '📦 Boxes', freeL: '🎨 Free', proL: '🃏 Pro',
    ...
    steps: [
      { id: 'style', l: 'Style', q: 'Presentation style?', o: ['📦 Structured', '🎨 Free Sketch', '🃏 Pro Cards'] },
  ...
  ru: {
    title: 'Скетчноут Визуализатор', sub: 'Структурированный · Свободный · Профи-карты · стиль Бикабло',
    ...
    structured: '📦 Структура', freeSketch: '🎨 Свободный', proCards: '🃏 Профи-карты',
    loading: 'Создание скетчноута...', neu: '← Новый', reroll: '🎲 Перегенерировать',
    edit: '📝 Редактировать', done: '✓ Готово', boxes: '📦 Блоки', freeL: '🎨 Свободный', proL: '🃏 Профи',
    ...
    steps: [
      { id: 'style', l: 'Стиль', q: 'Стиль представления?', o: ['📦 Структурированный', '🎨 Свободный скетч', '🃏 Профи-карты'] },
