...
export const T = {
  de: {
    ...
    structured: '📦 Strukturiert', freeSketch: '🎨 Freie Skizze', proCards: '🃏 Profi-Karten', bildstark: '🖼️ Bildstark',
    loading: 'Sketchnote wird erstellt...', neu: '← Neu', reroll: '🎲 Neu würfeln',
    edit: '📝 Bearbeiten', done: '✓ Fertig', boxes: '📦 Kästchen', freeL: '🎨 Frei', proL: '🃏 Profi', bildL: '🖼️ Bild',
    ...
    steps: [
      { id: 'style', l: 'Stil', q: 'Darstellungsstil?', o: ['📦 Strukturiert', '🎨 Freie Skizze', '🃏 Profi-Karten', '🖼️ Bildstark'] },
  ...
  en: {
    ...
    structured: '📦 Structured', freeSketch: '🎨 Free Sketch', proCards: '🃏 Pro Cards', bildstark: '🖼️ Visual Bold',
    loading: 'Creating sketchnote...', neu: '← New', reroll: '🎲 Reroll',
    edit: '📝 Edit', done: '✓ Done', boxes: '📦 Boxes', freeL: '🎨 Free', proL: '🃏 Pro', bildL: '🖼️ Bold',
    ...
    steps: [
      { id: 'style', l: 'Style', q: 'Presentation style?', o: ['📦 Structured', '🎨 Free Sketch', '🃏 Pro Cards', '🖼️ Visual Bold'] },
  ...
  ru: {
    ...
    structured: '📦 Структура', freeSketch: '🎨 Свободный', proCards: '🃏 Профи-карты', bildstark: '🖼️ Наглядный',
    loading: 'Создание скетчноута...', neu: '← Новый', reroll: '🎲 Перегенерировать',
    edit: '📝 Редактировать', done: '✓ Готово', boxes: '📦 Блоки', freeL: '🎨 Свободный', proL: '🃏 Профи', bildL: '🖼️ Нагляд.',
    ...
    steps: [
      { id: 'style', l: 'Стиль', q: 'Стиль представления?', o: ['📦 Структурированный', '🎨 Свободный скетч', '🃏 Профи-карты', '🖼️ Наглядный'] },
