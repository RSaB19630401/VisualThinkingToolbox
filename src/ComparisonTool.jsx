...
const CT = {
  de: {
    title: 'Vorher / Nachher', sub: 'Transformationen sichtbar machen · Bikablo oder Clean',
  ...
  en: {
    title: 'Before / After', sub: 'Make transformations visible · Bikablo or Clean',
  ...
  ru: {
    title: 'До / После', sub: 'Визуализация трансформаций · Бикабло или Чистый',
