// icons.jsx — 23 Upgraded Bikablo-style icon symbols
// More refined versions with better detail and line quality.
...
export function Ic(name, x, y, s, c) {
  ...
  const m = {
    ...
    heart: () => (<g transform={t}>
      <path d="M17,30 C4,22 0,10 8,5 C12,2 17,6 17,10 C17,6 22,2 26,5 C34,10 30,22 17,30Z" fill={c} opacity="0.7" stroke={c} strokeWidth="1"/>
    </g>),
    star: () => {
      const p = [];
      for (let i = 0; i < 10; i++) {
      ...
      return (<g transform={t}><polygon points={p.join(' ')} fill={c} opacity="0.7" stroke={c} strokeWidth="0.8"/></g>);
    },
    checkmark: () => (<g transform={t}>
    ...
    rocket: () => (<g transform={t}>
      <path d="M17,2 C12,8 11,18 13,26 L17,22 L21,26 C23,18 22,8 17,2Z" fill="none" stroke={c} strokeWidth={lw}/>
    ...
    clock: () => (<g transform={t}>
      ...
      {[0, 90, 180, 270].map((a, i) => {
        ...
        return <line key={i} x1={17 + 12 * Math.cos(rad)} y1={17 + 12 * Math.sin(rad)} x2={17 + 14 * Math.cos(rad)} y2={17 + 14 * Math.sin(rad)} stroke={c} strokeWidth="1.5"/>;
      })}
    </g>),
    speech: () => (<g transform={t}>
    ...
    ear: () => (<g transform={t}>
      <path d="M20,4 Q6,4 6,18 Q6,32 18,32 Q14,24 18,20 Q22,16 20,10 Q18,6 20,4Z" fill="none" stroke={c} strokeWidth={lw}/>
    ...
    brain: () => (<g transform={t}>
      <path d="M17,5 Q7,5 7,13 Q3,13 3,19 Q3,25 9,27 Q9,32 17,32 Q25,32 25,27 Q31,25 31,19 Q31,13 27,13 Q27,5 17,5Z" fill="none" stroke={c} strokeWidth={lw}/>
